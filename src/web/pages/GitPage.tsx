  ...
  return (
    <li className="rounded-lg border border-surface-border bg-surface-1" data-testid="git-epic">
      ...
      {epic.commits.length > 0 && (
        <div className="border-t border-surface-border px-4 py-3" data-testid="git-commits">
          <p className="mb-2 text-xs font-medium text-slate-400">Commits on this branch</p>
      ...
      {/* Files */}
      {epic.files.length > 0 && (
        <div className="border-t border-surface-border px-4 py-3" data-testid="git-files">
          <p className="mb-2 text-xs font-medium text-slate-400">Files changed</p>
      ...
      {epic.tasks.length > 0 && (
        <div className="border-t border-surface-border px-4 py-3">
          <p className="mb-2 text-xs font-medium text-slate-400">Tasks</p>
          <ul className="space-y-1">
            {epic.tasks.map((t) => (
